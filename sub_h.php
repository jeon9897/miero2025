...
<head>
  ...
  <!-- css초기화 -->
  <link href="http://design2012.dothome.co.kr/miero2025/css/reset.css" type="text/css" rel="stylesheet">
  
  <!-- 기본서식 -->
  <link href="http://design2012.dothome.co.kr/miero2025/css/base.css" type="text/css" rel="stylesheet">

  <!-- 공통서식 (상단헤더, 푸터서식) -->
  <link href="http://design2012.dothome.co.kr/miero2025/css/common.css" type="text/css" rel="stylesheet">

  <!-- 서브페이지 서식 -->
  <link href="http://design2012.dothome.co.kr/miero2025/css/sub.css" type="text/css" rel="stylesheet">
...
<body>
  ...
  <header>
    <h1>
      <a href="../../miero2025/index.html" title="메인페이지로 바로가기">
        <img src="http://design2012.dothome.co.kr/miero2025/images/logo2.png" alt="상단로고">
      </a>
    </h1>
  ...
  <main>
    <section class="con">
      ...
      <nav>
        <ul>
          <li><a href="http://design2012.dothome.co.kr/miero2025" title="홈으로 가기">HOME</a></li>
          <li>공지사항</li>
        </ul>
      </nav>
